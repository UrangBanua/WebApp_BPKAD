...
type
  TfrmHtmlTujuan = class(TUniFrame)
    UniPanel1: TUniPanel;
    upModif: TUniPanel;
    ubtModif: TUniBitBtn;
    ubtSave: TUniBitBtn;
...
procedure TfrmHtmlTujuan.ubtModifClick(Sender: TObject);
begin
...
procedure TfrmHtmlTujuan.ubtSaveClick(Sender: TObject);
begin
