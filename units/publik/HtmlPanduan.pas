...
type
  TfrmHtmlPanduan = class(TUniFrame)
    UniPanel1: TUniPanel;
...
procedure TfrmHtmlPanduan.ubtModifClick(Sender: TObject);
begin
...
procedure TfrmHtmlPanduan.ubtSaveClick(Sender: TObject);
begin
